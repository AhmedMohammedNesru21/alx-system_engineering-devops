...
Lets also add other subdomains to make our life easier, and write a Bash script that will display information about subdomains.
...
## Author
* **Ahmed Mohammed** - [arvicrin](https://github.com/AhmedMohammedNesru21)
